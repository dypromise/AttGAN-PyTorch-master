...
class Generator(nn.Module):
    def __init__(self, enc_dim=64, enc_layers=5, enc_norm_fn='batchnorm',
                 ...
                 dec_norm_fn='batchnorm', dec_acti_fn='relu', n_attrs=13,
...
class AttGAN():
    def __init__(self, args):
        ...
        self.G = Generator(
            ...
            args.n_attrs, args.shortcut_layers, args.inject_layers,
            args.img_size
        )
        self.G.train()
        if self.gpu:
